...
public class AlternativesSemanticSelectDescriptionTest implements TestContext {
    ...
    public void testAskWithExactPredicate(Supplier<TBoxMaterializer> supplier) {
        ...
        AlternativesSemanticSelectDescription d = new AlternativesSemanticSelectDescription(ep, reasoner);
    ...
    public void testVarWithExactClass(Supplier<TBoxMaterializer> supplier) {
        reasoner = supplier.get();
        reasoner.load(tBoxSpec);
        AlternativesSemanticSelectDescription d = new AlternativesSemanticSelectDescription(ep, true, reasoner);
    ...
    public void testMatchSubPropertyWithFilter(Supplier<TBoxMaterializer> supplier) {
        reasoner = supplier.get();
        reasoner.load(tBoxSpec);
        AlternativesSemanticSelectDescription description;
        description = new AlternativesSemanticSelectDescription(ep, true, reasoner);
