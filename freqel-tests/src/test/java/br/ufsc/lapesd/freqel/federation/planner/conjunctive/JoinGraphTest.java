...
import static br.ufsc.lapesd.freqel.description.molecules.annotations.AtomInputAnnotation.asRequired;
...
public class JoinGraphTest implements TestContext {
    ...
    private static final List<NamedFunction<RefIndexSet<Op>, JoinGraph>> factoriesForInputs = asList(
            new NamedFunction<>("InputsBitJoinGraph", InputsBitJoinGraph::new),
            new NamedFunction<>("ArrayJoinGraph()", ArrayJoinGraph::new)
    );
