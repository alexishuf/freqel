...
import static br.ufsc.lapesd.freqel.federation.planner.conjunctive.bitset.AbstractStateHelper.*;
import static br.ufsc.lapesd.freqel.federation.planner.conjunctive.bitset.InputStateHelper.INPUTS;
...
public class InputStateHelperTest implements TestContext {
    ...
    private static class State {
        private final IdentityHashSet<Op> nodes;
        private final Set<String> vars, reqInputVars;
        ...
        public boolean matches(@Nonnull InputStateHelper helper, @Nonnull long[] state) {
            ...
            return this.triples.equals(triples);
        }
