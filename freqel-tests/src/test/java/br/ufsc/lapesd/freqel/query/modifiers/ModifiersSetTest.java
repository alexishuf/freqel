...
public class ModifiersSetTest implements TestContext {
    ...
    public void testEnforceUniqueCapabilities() {
        ...
        assertTrue(set.add(SPARQLFilterFactory.parseFilter("?u > 23")));
    ...
    public void testNotifyAddAndRemove() {
        ...
        assertTrue(copy.add(SPARQLFilterFactory.parseFilter("?u > 23")));
        assertTrue(copy.add(SPARQLFilterFactory.parseFilter("?u > 24")));
        assertEquals(copyAdds.get(), 2);
        assertEquals(copyRemoves.get(), 0);
        assertTrue(copy.remove(SPARQLFilterFactory.parseFilter("?u > 24")));
        assertEquals(copyAdds.get(), 2);
        ...
        assertTrue(set.add(SPARQLFilterFactory.parseFilter("?x < 23")));
        assertTrue(set.remove(SPARQLFilterFactory.parseFilter("?x < 23")));
