...
@Singleton
public interface TestComponent extends FederationComponent {
    MatchingStrategy matchingStrategy();
    Agglutinator agglutinator();
    ConjunctivePlanner conjunctivePlanner();
    BitsetNoInputsConjunctivePlanner bsNoInputsPlanner();
    JoinOrderPlanner joinOrderPlanner();
    GreedyJoinOrderPlanner greedyJoinOrderPlanner();
    DefaultFilterJoinPlanner defaultFilterJoinPlanner();
    PlanningExecutorService planningExecutorService();
    PrePlanner prePlanner();
    PostPlanner postPlanner();
    ResultsExecutor resultsExecutor();
    QueryOpExecutor queryOpExecutor();
    PlanExecutor planExecutor();
    SimplePipeOpExecutor simplePipeOpExecutor();
    ReplacementPruner replacementPruner();
    UnionOpExecutor unionOpExecutor();

    @Component.Builder
    interface Builder extends FederationComponent.Builder {
