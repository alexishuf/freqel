        ...
        protected class APIEGQueryBuilder extends EGQueryBuilder {
            ...
            private void getInputsFromFilters() {
                assert subsumption2matched.keySet().stream()
                        .allMatch(JenaSPARQLFilter.SubsumptionResult::getValue);
                for (Map.Entry<JenaSPARQLFilter.SubsumptionResult, AtomFilter> e
                        : subsumption2matched.entrySet()) {
                    JenaSPARQLFilter.SubsumptionResult result = e.getKey();
