...
import static br.ufsc.lapesd.riefederator.federation.cardinality.impl.QuickSelectivityHeuristic.cost;
...
public class QuickSelectivityHeuristicTest implements TestContext {
    ...
    public void testBadCartesian(@Nonnull Supplier<CardinalityHeuristic> supplier) {
        ...
        assertTrue(min >= 2* QuickSelectivityHeuristic.cost(Alice, name, x));
