...
public abstract class AbstractBitsetConjunctivePlanner implements ConjunctivePlanner {
    private static Logger logger = LoggerFactory.getLogger(AbstractBitsetConjunctivePlanner.class);
    ...
    protected boolean validInput(@Nonnull CQuery query, @Nonnull Collection<Op> fragments) {
        ...
        assert fragments.stream().map(o -> o.getAllVars()).allMatch(IndexSubset.class::isInstance);
