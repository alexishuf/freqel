...
public interface Planner {
     ...
     *
     * The {@link Op}s given should be either {@link UnionOp}s or {@link QueryOp}s.
     *
     ...
     *                  {@link UnionOp}s or {@link QueryOp}s
     * @throws IllegalArgumentException if fragments is empty.
     * @return The root of the query plan.
     */
    @Nonnull
    Op plan(@Nonnull CQuery query, @Nonnull Collection<Op> fragments);
}
