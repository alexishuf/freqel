...
//        assertTrue(asList(12, 10).equals(sub));
    ...
    public void testEqualsWithSingleton() {
        IndexSet<Triple> a = FullIndexSet.fromDistinct(singletonList(new Triple(TestContext.Alice, TestContext.age, TestContext.u)));
        Set<Triple> b = singleton(new Triple(TestContext.Alice, TestContext.age, TestContext.u));
        assertEquals(a, b);
    ...
    public void testEqualsRegression() {
        IndexSet<Triple> a1 = FullIndexSet.fromDistinct(singletonList(new Triple(TestContext.Alice, TestContext.age, TestContext.u)));
        IndexSet<Triple> a2 = FullIndexSet.fromDistinct(singletonList(new Triple(TestContext.Alice, TestContext.age, TestContext.v)));
        Set<Triple> b1 = singleton(new Triple(TestContext.Alice, TestContext.age, TestContext.u));
        Set<Triple> b2 = singleton(new Triple(TestContext.Alice, TestContext.age, TestContext.v));
