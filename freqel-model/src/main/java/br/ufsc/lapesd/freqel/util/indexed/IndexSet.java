...
public interface IndexSet<T> extends List<T>, Set<T> {
    ...
    /**
     * Behaves like {@link Set#add(Object)}.
     *
     * @param t object to add to the set
     * @return true iff the set was modified (t was not present)
     */
    @Contract("null -> false ; !null -> _") //this keeps the IDE from expecting always true
