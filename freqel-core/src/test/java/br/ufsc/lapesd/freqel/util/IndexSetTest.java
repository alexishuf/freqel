...
//        assertTrue(asList(12, 10).equals(sub));
    ...
    public void testEqualsWithSingleton() {
        IndexSet<Triple> a = FullIndexSet.fromDistinct(singletonList(new Triple(Alice, age, u)));
    ...
    public void testEqualsRegression() {
        IndexSet<Triple> a1 = FullIndexSet.fromDistinct(singletonList(new Triple(Alice, age, u)));
        IndexSet<Triple> a2 = FullIndexSet.fromDistinct(singletonList(new Triple(Alice, age, v)));
