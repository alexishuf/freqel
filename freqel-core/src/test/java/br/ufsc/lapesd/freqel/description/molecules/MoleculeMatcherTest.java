...
public class MoleculeMatcherTest implements TestContext {
    ...
    public static final @Nonnull Molecule person1o = Molecule.builder("Person1o")
            .out(name, new Atom("name")).build();
    public static final @Nonnull Molecule person2o = Molecule.builder("Person2o")
            .out(name, new Atom("name")).out(age, new Atom("age")).build();
    public static final @Nonnull Molecule person1i2o = Molecule.builder("Person1i2o")
            .in(primaryTopic, new Atom("Document"))
            .out(name, new Atom("name")).out(age, new Atom("age")).build();

    /* ~~~ same as above but disjoint ~~~ */

    public static final @Nonnull Molecule person1od = Molecule.builder("Person1od")
            .out(name, new Atom("name"))
            .disjoint().build();
    public static final @Nonnull Molecule person2od = Molecule.builder("Person2od")
            .out(name, new Atom("name")).out(age, new Atom("age"))
            .disjoint().build();
    public static final @Nonnull Molecule person2od1 = Molecule.builder("Person2od1")
            .out(name, Molecule.builder("name").nonDisjoint().buildAtom())
            .out(age, Molecule.builder("age").disjoint().buildAtom())
            .disjoint().build();
    public static final @Nonnull Molecule person2od2 = Molecule.builder("Person2od2")
    ...
    public static final @Nonnull Molecule person1oe = Molecule.builder("Person1oe")
            .out(name, new Atom("name"))
            .exclusive().closed().build();
    public static final @Nonnull Molecule person2oe = Molecule.builder("Person2oe")
            .out(name, new Atom("name")).out(age, new Atom("age"))
            .exclusive().closed().build();
    public static final @Nonnull Molecule person1i2oe = Molecule.builder("Person1i2oe")
            .exclusive().closed()
            .in(primaryTopic, new Atom("Document"))
            .out(name, new Atom("name")).out(age, new Atom("age"))
            .exclusive().closed().build();
    ...
    public static final @Nonnull Molecule person1oed = Molecule.builder("Person1oed")
            .out(name, new Atom("name"))
            .exclusive().closed().disjoint().build();
    public static final @Nonnull Molecule person2oed = Molecule.builder("Person2oed")
            .out(name, new Atom("name")).out(age, new Atom("age"))
            .exclusive().closed().disjoint().build();
    public static final @Nonnull Molecule person2oed1 = Molecule.builder("Person2oed1")
            .out(name, Molecule.builder("name").nonDisjoint().buildAtom())
            .out(age, Molecule.builder("age").disjoint().buildAtom())
            .exclusive().closed().disjoint().build();
    public static final @Nonnull Molecule person2oed2 = Molecule.builder("Person2oed2")
            .out(name, Molecule.builder("name").disjoint().buildAtom())
            .out(age, Molecule.builder("age").disjoint().buildAtom())
            .exclusive().closed().disjoint().build();
    public static final @Nonnull Molecule person1i2oed = Molecule.builder("Person1i2oed")
            .exclusive().closed()
            .in(primaryTopic, new Atom("Document"))
            .out(name, new Atom("name")).out(age, new Atom("age"))
            .exclusive().closed().disjoint().build();
    ...
    public static final @Nonnull Molecule person1i2oe1f = Molecule.builder("Person2oe1f")
            .in(primaryTopic,
    ...
    /* ~~~ large molecule ~~~ */
    private static final StdURI worksFor = new StdURI("http://example.org/uni/worksFor");
    private static final StdURI hostedBy = new StdURI("http://example.org/uni/hostedBy");
    private static final StdURI enrolledAt = new StdURI("http://example.org/uni/enrolledAt");
    private static final StdURI supervisor = new StdURI("http://example.org/uni/supervisor");
    private static final StdURI supervised = new StdURI("http://example.org/uni/supervised");
    private static final StdURI teaches = new StdURI("http://example.org/uni/teaches");
    private static final StdURI hasProfessor = new StdURI("http://example.org/uni/hasProfessor");
    private static final StdURI courseCode = new StdURI("http://example.org/uni/courseCode");
    private static final StdURI takes = new StdURI("http://example.org/uni/takes");
    private static final StdURI hasStudent = new StdURI("http://example.org/uni/hasStudent");
    private static final StdURI advises = new StdURI("http://example.org/uni/advises");
