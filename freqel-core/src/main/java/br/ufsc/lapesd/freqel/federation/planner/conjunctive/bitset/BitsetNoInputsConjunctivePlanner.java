...
import static br.ufsc.lapesd.freqel.util.RawAlignedBitSet.andNot;
import static br.ufsc.lapesd.freqel.util.RawAlignedBitSet.cardinality;
...
public class BitsetNoInputsConjunctivePlanner extends AbstractBitsetConjunctivePlanner {
    ...
    @Nonnull List<?> findComponents(@Nonnull CQuery query, @Nonnull BitJoinGraph nodes) {
        ...
        assert offer != null;
        helper = new NoInputStateHelper(nodes, offer, (IndexSubset<Triple>) query.attr().getSet());
