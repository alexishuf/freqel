...
import br.ufsc.lapesd.freqel.query.parse.impl.ConvertOptions;
import br.ufsc.lapesd.freqel.query.parse.impl.ConvertVisitor;
...
public class SPARQLParser {
    ...
    private final static SPARQLParser TOLERANT = new SPARQLParser()
            ...
            .lockConfiguration();
    private final ConvertOptions convertOptions = new ConvertOptions();
