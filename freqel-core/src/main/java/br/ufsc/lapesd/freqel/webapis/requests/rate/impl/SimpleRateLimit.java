package br.ufsc.lapesd.freqel.webapis.requests.rate.impl;

import br.ufsc.lapesd.freqel.webapis.requests.rate.RateLimit;
...
public class SimpleRateLimit implements RateLimit {
    ...
    private final @Nonnull Semaphore semaphore = new Semaphore(1);
    private final @Nonnull Stopwatch idle;
